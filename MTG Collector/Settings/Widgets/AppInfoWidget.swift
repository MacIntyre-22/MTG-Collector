...
struct AppInfoWidget: View {
    ...
    var info: String = """
    Cardhold is an independent app and is not affiliated with Wizards of the Coast in any way. All Magic: The Gathering content (card names, images, related marks, and fonts) belong to Wizards of the Coast LLC.
